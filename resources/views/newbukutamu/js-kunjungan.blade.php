    ...
    $.ajax({
        ...
        success: function(d){
            ...
            if (d.data.kunjungan_foto != null)
                ...
                {
                    $('#ViewKunjunganModal .modal-body #tamu_foto').attr("src","https://placehold.co/480x360/0000FF/FFFFFF/?text=belum+ada+photo")
                }
...
$('#EditTindakLanjutModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        ...
        success: function(d){
            ...
            $('#EditTindakLanjutModal .modal-footer #kunjungan_timeline').attr("href","{{route('tamu.detil','')}}/"+d.data.kunjungan_uid)
...
$('#EditTujuanModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        ...
        success: function(d){
            ...
            $('#EditTujuanModal .modal-footer #kunjungan_timeline').attr("href","{{route('tamu.detil','')}}/"+d.data.kunjungan_uid)
...
$('#EditJenisKunjunganModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        ...
        success: function(d){
            ...
            $('#EditJenisKunjunganModal .modal-footer #kunjungan_timeline').attr("href","{{route('tamu.detil','')}}/"+d.data.kunjungan_uid)
