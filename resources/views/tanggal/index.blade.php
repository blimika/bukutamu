    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            @if (Auth::User()->level > 10)
                <a href="javascript:void(0)" class="btn btn-success d-lg-block m-l-15" data-toggle="modal" data-target="#GenerateTanggal"><i class="fa fa-plus-circle"></i> Generate Tanggal</a>
            @endif
        </div>
    </div>
</div>
