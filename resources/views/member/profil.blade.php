                        ...
                        <h6 class="card-subtitle">{{Auth::user()->mLevel->nama}}</h6>
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-lg-9 col-sm-9">
                                    ...
                                    @else
                                        <span class="badge badge-pill badge-success">sudah terkoneksi</span> <button class="btn btn-sm btn-rounded btn-danger putuskan" id="PutuskanKoneksi" data-id="{{Auth::user()->id}}" data-nama="{{Auth::user()->name}}" data-kodeqr="{{ Auth::user()->Pengunjung->pengunjung_uid }}"><i class="fas fa-bolt" data-toggle="tooltip" title="Putuskan kaitan"></i> PUTUSKAN</button>
                                    @endif
                                </dd>
                            </dl>
